...
func (in *AntManJobType) DeepCopyInto(out *AntManJobType) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AntManJobType.
func (in *AntManJobType) DeepCopy() *AntManJobType {
	if in == nil {
		return nil
	}
	out := new(AntManJobType)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TFJobSpec) DeepCopyInto(out *TFJobSpec) {
	*out = *in
	...
	if in.AntManJobType != nil {
		in, out := &in.AntManJobType, &out.AntManJobType
		*out = new(AntManJobType)
		(*in).DeepCopyInto(*out)
	}
}
